...
Main = (function()
  ...
  Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
    local gui = create({
      ...
      {2,"Frame",{Active=true,BackgroundColor3=Color3.new(0.117,0.564,0.678),BorderSizePixel=0,Name="Main",Parent={1},Position=UDim2.new(0.5,-175,0.5,-100),Size=UDim2.new(0,350,0,200),}},
      {3,"Frame",{BackgroundColor3=Color3.new(0.094,0.396,0.588),BorderSizePixel=0,ClipsDescendants=true,Name="Holder",Parent={2},Size=UDim2.new(1,0,1,0),}},
      {4,"UIGradient",{Parent={3},Rotation=30,Color=ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.new(0.2,0.7,1)), ColorSequenceKeypoint.new(1, Color3.new(0.1,0.4,0.8))}),}},
      {5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="Aqua Hub",TextColor3=Color3.new(0.5,0.8,1),TextSize=50,TextTransparency=1,}},
      {6,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Desc",Parent={3},Position=UDim2.new(0,-230,0,60),Size=UDim2.new(0,180,0,25),Text="The Best Hub To Ever Exist",TextColor3=Color3.new(0.9,0.95,1),TextSize=18,TextTransparency=1,}},
      {7,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="StatusText",Parent={3},Position=UDim2.new(0,20,0,110),Size=UDim2.new(0,180,0,25),Text="Fetching API",TextColor3=Color3.new(0.9,0.95,1),TextSize=14,TextTransparency=1,}},
      {8,"Frame",{BackgroundColor3=Color3.new(0.117,0.564,0.678),BorderSizePixel=0,Name="ProgressBar",Parent={3},Position=UDim2.new(0,110,0,145),Size=UDim2.new(0,0,0,4),}},
      {9,"Frame",{BackgroundColor3=Color3.new(0.098,0.831,1),BorderSizePixel=0,Name="Bar",Parent={8},Size=UDim2.new(0,0,1,0),}},
      {10,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image="rbxassetid://2764171053",ImageColor3=Color3.new(0.094,0.396,0.588),Parent={8},ScaleType=1,Size=UDim2.new(1,0,1,0),SliceCenter=Rect.new(2,2,254,254),}},
      {11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Developed by ExploitFin",TextColor3=Color3.new(0.9,0.95,1),TextSize=14,TextXAlignment=1,}},
      {12,"UIGradient",{Parent={11},Color=ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.new(0.2,0.7,1)), ColorSequenceKeypoint.new(1, Color3.new(0.1,0.4,0.8))}),}},
      {13,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Version",Parent={2},Position=UDim2.new(1,-110,1,-35),Size=UDim2.new(0,105,0,20),Text=Main.Version,TextColor3=Color3.new(0.9,0.95,1),TextSize=14,TextXAlignment=1,}},
      {14,"UIGradient",{Parent={13},Color=ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.new(0.2,0.7,1)), ColorSequenceKeypoint.new(1, Color3.new(0.1,0.4,0.8))}),}},
      ...
      {16,"UIGradient",{Parent={15},Rotation=-30,Color=ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.new(0.2,0.7,1)), ColorSequenceKeypoint.new(1, Color3.new(0.1,0.4,0.8))}),}},
      {17,"UIGradient",{Parent={2},Rotation=-30,Color=ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.new(0.2,0.7,1)), ColorSequenceKeypoint.new(1, Color3.new(0.1,0.4,0.8))}),}},
    })
    Main.ShowGui(gui)
  ...
  Main.SetMainGuiOpen = function(val)
    ...
    Main.MainGui.OpenButton.Text = val and "X" or "-"
...
Main.CreateMainGui = function()
    local gui = create({
      ...
      {2,"TextButton",{AnchorPoint=Vector2.new(0.5,0),AutoButtonColor=false,BackgroundColor3=Color3.new(0.152,0.75,0.83),BorderSizePixel=0,Font=4,Name="OpenButton",Parent={1},Position=UDim2.new(0.5,0,0,2),Size=UDim2.new(0,32,0,32),Text="Fin",TextColor3=Color3.new(1,1,1),TextSize=16,TextTransparency=0.20000000298023,}},
      {3,"UICorner",{CornerRadius=UDim.new(0,4),Parent={2},}},
      {4,"Frame",{AnchorPoint=Vector2.new(0.5,0),BackgroundColor3=Color3.new(0.152,0.75,0.83),ClipsDescendants=true,Name="MainFrame",Parent={2},Position=UDim2.new(0.5,0,1,-4),Size=UDim2.new(0,224,0,200),}},
      {5,"UICorner",{CornerRadius=UDim.new(0,4),Parent={4},}},
      {6,"Frame",{BackgroundColor3=Color3.new(0.2,0.8,0.8),Name="BottomFrame",Parent={4},Position=UDim2.new(0,0,1,-24),Size=UDim2.new(1,0,0,24),}},
      {7,"UICorner",{CornerRadius=UDim.new(0,4),Parent={6},}},
      {8,"Frame",{BackgroundColor3=Color3.new(0.2,0.8,0.8),BorderSizePixel=0,Name="CoverFrame",Parent={6},Size=UDim2.new(1,0,0,4),}},
      {9,"Frame",{BackgroundColor3=Color3.new(0.1,0.6,0.7),BorderSizePixel=0,Name="Line",Parent={8},Position=UDim2.new(0,0,0,-1),Size=UDim2.new(1,0,0,1),}},
      ...
      {14,"ScrollingFrame",{Active=true,AnchorPoint=Vector2.new(0.5,0),BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderColor3=Color3.new(0.1,0.6,0.7),BorderSizePixel=0,Name="AppsFrame",Parent={4},Position=UDim2.new(0.5,0,0,0),ScrollBarImageColor3=Color3.new(0,0,0),ScrollBarThickness=4,Size=UDim2.new(0,222,1,-25),}},
      ...
      {18,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.18,0.75,0.83),BorderSizePixel=0,Font=3,Name="Main",Parent={17},Size=UDim2.new(1,0,0,60),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
      ...
      {20,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="AppName",Parent={18},Position=UDim2.new(0,2,0,38),Size=UDim2.new(1,-4,1,-40),Text="Aqua Hub's Explorer",TextColor3=Color3.new(1,1,1),TextSize=14,TextTransparency=0.10000000149012,TextTruncate=1,TextWrapped=true,TextYAlignment=0,}},
      {21,"Frame",{BackgroundColor3=Color3.new(0,0.6,0.8),BorderSizePixel=0,Name="Highlight",Parent={18},Position=UDim2.new(0,0,1,-2),Size=UDim2.new(1,0,0,2),}},
    })
    Main.MainGui = gui
...
Main.CreateApp({
    ...
    Icon = "Copy", -- Replace with an appropriate icon
    OnClick = function(callback)
        if callback then
            local discordInviteLink = "https://discord.gg/GzQGE9rr26"
...
local fileName = "aquahubexplorer.txt"
local correctKey = game.Players.LocalPlayer.Name -- Using player's username as the key
...
SubmitButton.Size = UDim2.new(0.4, -5, 0, 35)
SubmitButton.Position = UDim2.new(0.075, 0, 0.7, 0)
SubmitButton.Text = "Submit"
SubmitButton.Font = Enum.Font.GothamBold
SubmitButton.TextSize = 18
SubmitButton.BackgroundColor3 = Color3.fromRGB(34, 150, 243)
...
GetKeyButton.Size = UDim2.new(0.4, -5, 0, 35)
GetKeyButton.Position = UDim2.new(0.525, 5, 0.7, 0)
...
UICornerGetKey.CornerRadius = UDim.new(0, 8)

-- Button scale animation effect
...
scaleButton(SubmitButton)
scaleButton(GetKeyButton)

-- Validate stored key or prompt user
if isfile(fileName) then
    local storedKey = readfile(fileName)
    if storedKey == correctKey then
    ...
    print("You did not enter a key! WHAT THE SIGMA")
end
...
SubmitButton.MouseButton1Click:Connect(function()
    ...
    if inputKey == correctKey then
        writefile(fileName, inputKey) -- Save valid key

        -- Success effect
        local successTween = TweenService:Create(Frame, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(34, 139, 34)})
        successTween:Play()

        -- Fade-out animation for UI before destroying
        ...
        errorSound.SoundId = "rbxassetid://6716131917" -- Replace with the asset ID of your error sound
        errorSound.Volume = 1
        ...
        if not isShaking then
            ...
            local failTween = TweenService:Create(Frame, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(139, 0, 0)})
            failTween:Play()

            local shakeTween1 = TweenService:Create(Frame, TweenInfo.new(0.1), {Position = Frame.Position + UDim2.new(0, 5, 0, 0)})
            local shakeTween2 = TweenService:Create(Frame, TweenInfo.new(0.1), {Position = Frame.Position - UDim2.new(0, 5, 0, 0)})
            ...
            shakeTween1.Completed:Connect(function()
                ...
                shakeTween2.Completed:Connect(function()
                    isShaking = false
                    local resetColorTween = TweenService:Create(Frame, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(45, 45, 48)})
...
GetKeyButton.MouseButton1Click:Connect(function()
    setclipboard("https://discord.gg/EHBR7qKN")
